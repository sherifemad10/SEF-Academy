  ...
  return (
    <div className="Contact">
      <div className="contact-wrapper">
        <div className="contact-contant container">
          <div className="article-header">
            <div className="admin-panel">
              <p className="AdminPanel">Contact Us</p>
              <p>6th June 2024</p>
            </div>
          </div>{" "}
          {/* article-header */}
          <div className="conatct-page-body">
            <div className="conatct-page-body-info">
              <div className="conatct-page-body-info-text">
                <h3>Location</h3>
                <p>Egypt, Cairo</p>
              </div>

              <div className="conatct-page-body-info-text">
                <h3>Leave us an email</h3>
    ...
    c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"
            ...
            {/* end conatct-page-body-info */}

            <div className="conatct-page-body-form">
              <h3>GET IN TOUCH</h3>
              <p>We'd love to hear from you</p>

              <form className="contact-form" ref={form} onSubmit={sendEmail}>
                <div className="contact-form-fist-lastName">
                  <div className="contact-form-fist">
                ...
                <div className="conatct-form-send-btn">
